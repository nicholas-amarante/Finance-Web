                        ...
                        <div className='bg-white w-full h-auto p-6 sm:p-10 rounded-3xl flex flex-col justify-between shadow-2xl'>
                            ...
                            <form className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-6 font-p w-full'>
                                ...
                                <div className='flex flex-col gap-1.5'>
                                    ...
                                    <Select name="accounts" id="" className='w-full' options={accountOptions} value={accountSelected} onChange={(e) => setAccountSelected(e.target.value)} disabled={!bankSelected}>
                                ...
                                <div className='flex flex-col gap-1.5'>
                                    ...
                                    <Input type="text" className='w-full' placeholder="Digite um destino (opcional)"/>
                                </div>
                                
                                <div className='flex flex-col gap-1.5 lg:col-span-2'>
                                    <label className="font-medium text-gray-700 text-sm">Descrição</label>
                                    <Input type="text" className='w-full' placeholder="Digite uma descrição (opcional)"/>
                                </div>
                            </form>
